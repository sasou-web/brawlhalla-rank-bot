...
function buildSections(guildId) {
  return {
    settings: {
      get: () => getSettings(),
      set: async (body) => {
        const keys = ["reviewChannelId", "reviewerRoleId", "auditChannelId", "announceChannelId", "alertChannelId", "achievementsChannelId", "autoApproveTier", "requireProofScreenshot", "proofTier"];
